...
def annotate_job():
    ...
    try:
        # send sns message https://docs.aws.amazon.com/code-samples/latest/catalog/python-sns-sns-python-example-publish-to-topic.py.html
        sns = boto3.client('sns', region_name='us-east-1')
        sns.publish(TopicArn='arn:aws:sns:us-east-1:127134666975:atinn_job_requests', Message=json.dumps(data))
    except botocore.exceptions.ClientError:
        return 500, "Job cannot be processed at this time"
